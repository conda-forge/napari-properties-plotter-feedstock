About napari-properties-plotter-feedstock
=========================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/napari-properties-plotter-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15162&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/napari-properties-plotter-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `napari-properties-plotter` can be installed with `conda`:
...
```
mamba install napari-properties-plotter
```

It is possible to list all of the versions of `napari-properties-plotter` available on your platform with `conda`:
...
```
mamba search napari-properties-plotter --channel conda-forge
```
...
mamba repoquery search napari-properties-plotter --channel conda-forge

# List packages depending on `napari-properties-plotter`:
mamba repoquery whoneeds napari-properties-plotter --channel conda-forge

# List dependencies of `napari-properties-plotter`:
mamba repoquery depends napari-properties-plotter --channel conda-forge
```
